...
AppName=Entry WCCP
AppVersion=1.0
AppVerName=Entry WCCP v1.0
AppPublisher=Synapser Limited
AppPublisherURL=http://www.synapser.com/
AppSupportURL=http://www.synapser.com/
AppUpdatesURL=http://www.synapser.com/
DefaultDirName={commonpf}\Entry WCCP
DefaultGroupName=Entry WCCP
AllowNoIcons=true
LicenseFile=..\LICENSE
OutputBaseFilename=EntryWCCPSetup-1.0
SetupIconFile=..\Installer\EntryWCCPIconAlpha.ico
Compression=lzma/Max
SolidCompression=true
AppCopyright=Synapser Limited
...
Source: ".\scripts\silent_script_local.ps1"; DestDir: "{tmp}"
Source: ".\scripts\settings_import_local_no_lockout_no_ldap.reg"; DestDir: "{tmp}"
...
Filename: "powershell.exe"; Parameters: "-ExecutionPolicy Bypass -File ""{tmp}\silent_script_local.ps1"""; WorkingDir: {tmp}; Flags: runhidden
